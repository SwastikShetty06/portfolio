      ...
      <div className="container mx-auto">
        <div className="flex flex-col lg:flex-row items-center justify-between max-w-7xl mx-auto gap-12 lg:gap-16 text-center lg:text-left">
          ...
          >
            ...
            >
              Hi, I'm <span className="text-sky-blue relative inline-block after:content-[''] after:absolute after:bottom-0 after:left-0 after:w-full after:h-1 after:bg-gradient-to-r from-sky-blue to-indigo after:rounded-full">Swastik</span>
            </motion.h1>
            
            <motion.h2 
              className="text-2xl md:text-3xl font-semibold text-sky-blue mb-8"
            ...
            <motion.p 
              className="text-lg md:text-xl text-indigo/80 mb-12 max-w-2xl mx-auto lg:mx-0 leading-relaxed"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
